...
ZIP_URL="https://raw.githubusercontent.com/adamteam93/hello/refs/heads/main/Lion_Docker.zip"
echo "[INFO] Загружаем Lion_Docker.zip..."
...
echo "[INFO] Используем backend-домен: $BACKEND_DOMAIN"
